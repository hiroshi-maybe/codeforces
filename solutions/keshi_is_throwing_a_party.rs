...
// $ cp-batch keshi_is_throwing_a_party | diff keshi_is_throwing_a_party.out -
// $ cargo run --bin keshi_is_throwing_a_party

///
/// 11/23/2021
///
/// 7:22-7:46, 8:10-8:53 WA
/// 9:02 AC
///
/// https://twitter.com/laycrs/status/1463201470392639489
...
fn solve() -> i32 {
    let n = readln!(usize);
    let ab = readlns!(i32, i32; n);

    let inf = 1000_000i32;
    let (mut good, mut bad) = (1, inf);
