...
// $ cp-batch CyclicPermutations | diff CyclicPermutations.out -
// $ g++ -std=c++14 -Wall -O2 -D_GLIBCXX_DEBUG -fsanitize=address CyclicPermutations.cpp && ./a.out
...
/*
 ...
 https://twitter.com/hanseilimak/status/1292692038882738177
...
void solve() {
  ModInt res=com.fact(N);
  REPE(i,N-1) res-=com.choose(N-1,i);
  cout<<res<<endl;
}
